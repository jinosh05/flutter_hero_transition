...
I kept the code as original as possible with proper Commented Guides for anyone to understand and implement. Still you need to follow these steps.
  ...
  - Now download this [Repo](https://github.com/jinosh05/flutter_hero_transition/archive/refs/heads/master.zip)
  - Extract the Repo into your newly created **flutter_hero_transition** and replace the required files.
